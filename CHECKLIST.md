...
- [ ] Update `name` to `@ansvar/international-health-law-mcp`
- [ ] Update `description`
...
Edit `CLAUDE.md`:
- [ ] Update project overview with your content domain
...
git remote add origin git@github.com:Ansvar-Systems/international-health-law-mcp.git
...
- [ ] Create directory `servers/international-health-law-mcp/`
- [ ] Create `server.yaml`:
  ```yaml
